...
> Primary target. `sessions/` rollout schema **inspected directly** on macOS (2026-08-10). Cross-agent context: `docs/research/AGENT_STORAGE_FORMATS.md`. Tags: **FACT** / **INFERENCE**.
>
