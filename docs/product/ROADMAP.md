...
- **Tests:** identifier/error/path/provenance recall; stable keyset pagination; warm/cold/adversarial <200 ms target report at 1M messages; chunk-boundary/middle-of-blob secrets absent from derived surfaces.
